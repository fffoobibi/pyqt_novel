...
class JiuJiuSpider(BasicFileSpider):
    ...
    def parse(self, response):
        ...
        for div_selector in selectors:
            ...
            _others1 = [v.strip() for v in div_selector.css(
                'div:nth-child(6) small::text').getall()]
            _others2 = [v.strip() for v in div_selector.css(
            ...
            yield scrapy.Request(url, headers=header, callback=self.getDownLoadUrl, meta={'inf': inf})
