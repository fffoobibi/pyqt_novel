    ...
    def paintEvent(self, event) -> None:
        ...
        if self.text_content:  # 绘制文本
            ...
            if not self._enter:
                ...
                text = "继续阅读" if latest.chapter_name is not None else "开始阅读"
        ...
        if self._enter:  # 绘制阅读信息
            ...
            painter.setCompositionMode(
                QPainter.CompositionMode_Difference)  # 颜色取反
...
class _AutoPages(MySequence):
    ...
    def split_page(self,
                   ...
                   start: int = None,
                   stop: int = None,
                   step: int = None) -> '_AutoPages':  # 分页, lines -> pages
    ...
    def addLines(self,
                 ...
                 args=(),
                 kwargs={},
                 first_title: bool = True) -> None:  # 添加行
        self.clear()
        for line in lines:
