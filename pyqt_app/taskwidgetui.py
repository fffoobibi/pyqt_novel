...
"")
        ...
        self.textBrowser = TaskReadBrowser(self.page_3)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/hl/bookmark_1223025_easyicon.net.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.markup_button.setIcon(icon10)
...
from .customwidgets import ColorButton, GifButton, ReadBar, TaskInfoLabel, TaskReadBrowser, TaskWidgetSubmitLabel
