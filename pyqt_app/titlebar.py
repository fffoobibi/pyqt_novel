...
from PyQt5.QtGui import QFont, QEnterEvent, QFontMetrics, QPainter, QColor, QPen, QPalette
...
class TitleBar(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.titleLabel.setAttribute(Qt.WA_TransparentForMouseEvents, True)  # 鼠标穿透,当前控件及其子控件均不响应鼠标事件
...
class FramelessWindow(QWidget):
    ...
    def addLeftTitleWidget(self,  widget, stretch=0, autoheight=True):
        self.titleBar.addLeftTitleWidget(widget, stretch, autoheight=autoheight)
